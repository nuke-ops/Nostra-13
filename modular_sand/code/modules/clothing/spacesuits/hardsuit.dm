...
/obj/item/clothing/head/helmet/space/hardsuit/powerarmor
	...
	armor = list("melee" = 75, "bullet" = 60, "laser" = 50, "energy" = 45, "bomb" = 65, "bio" = 60, "rad" = 10, "fire" = 75, "acid" = 100)
...
/obj/item/clothing/suit/space/hardsuit/powerarmor
	...
	armor = list("melee" = 75, "bullet" = 60, "laser" = 50, "energy" = 45, "bomb" = 65, "bio" = 60, "rad" = 10, "fire" = 75, "acid" = 100) //I was asked to buff this again. Here, fine.
	resistance_flags = ACID_PROOF
