...
/datum/techweb_node/bottle_exports
	...
	design_ids = list("minikeg", "blooddrop", "slim_gold", "white_bloodmoon", "greenroad", "emptyglassbottle", "largeemptyglassbottle", "bluespaceflask", "emptypitcher") //Nostra Change
