...
/datum/interaction/lewd/nipsuck/display_interaction(mob/living/carbon/human/user, mob/living/carbon/human/target)
	...
	playlewdinteractionsound(user.loc, pick('modular_nostration/sound/interactions/oral1.ogg',
...
/datum/interaction/lewd/nut_smack
	...
	interaction_sound = 'modular_nostration/sound/interactions/slap.ogg'
