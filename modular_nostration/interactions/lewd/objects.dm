...
/obj/item/dildo/attack(mob/living/carbon/human/M, mob/living/carbon/human/user)
	...
	if(message)
		...
		playsound(loc, pick('modular_nostration/sound/interactions/bang4.ogg',
							'modular_nostration/sound/interactions/bang5.ogg',
							'modular_nostration/sound/interactions/bang6.ogg'), 70, 1, -1)
